...
import LocationSetting from "../components/location-setup/locationsetting";
import PrintSetting from "../components/location-setup/print-setting/printsetting";
import LocationSetup from "../components/location-setup/locationsetup";
import Edit from "../components/location-setup/print-setting/edit";

// Menu Setup
import MenuSetupHome from "../components/menu_setup/menu";
...
export const routes = [
  ...
  // Setting File URL
  { path: "/app/settings", Component: SettingsHome },
  { path: "/app/location-setup/locationsetting", Component: LocationSetting},
  { path: "/app/location-setup/print-setting/printsetting", Component: PrintSetting},
  { path: "/app/location-setup/locationsetup", Component: LocationSetup},
  { path: "/app/location-setup/print-setting/edit", Component: Edit},

  // MENU SETUP PATHS
  { path: "/app/settings/menuSetup/", Component: MenuSetupHome },
  { path: "/app/settings/menuSetup/uploadMenu", Component: UploadMenu },
  { path: "/app/settings/menuSetup/addNewMenuItem", Component: AddNewMenuItem },

  { path: "/pos", Component: POS },

   //inventory File URL
   { path :"/app/inventory-Setting",Component: InventorySetting },
  
   //inventory InventoryHome URL 
   { path :"/app/inventory-Home",Component: InventoryHome},
   
   // inventory Categories URL
   { path :"/app/inventory-Categories",Component:IngredientCategories  },
   
   // inventory Categories URL
   { path :"/app/measurement-Unit",Component:MeasurementUnit },
   
   // inventory Ingredient & Sub Recipes
   { path :"/app/ingredient_Sub_Recipes",Component:Ingredint_Sub_Recipes },
   
   // inventory  Create_Ingredient
   { path :"/app/Create_Ingredient",Component: Create_Ingredient },
   
   
   // inventory  Create_Finished_Good
   { path :"/app/Create_Finished_Good",Component: Create_Finished_Good},
